public class TestClass {
  ...
  public static void outfitGeneratorLoop(OutfitGenerator outfitGenerator) {
    ...
    for (int i = 0; i < numIterations; i++) {
      ...
      if (counter == 1) {
        ...
        System.out.println(
            "It took the Outfit Generator " + counter + " attempts to find a good outfit. Wasn't it worth it though!");
      }
  ...
  public static void main(String[] args) {
    ...
    // Call the loop method to generate the outfits
    outfitGeneratorLoop(outfitGenerator);
